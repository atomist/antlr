 ...
 */
export class JavaScriptBaseLexer extends Lexer {
    /**
     * Stores values of nested modes. By default mode is strict or
     * defined externally (useStrictDefault)
     */
    protected scopeStrictModes: boolean[] = [];
    ...
    public getStrictDefault(): boolean {
        return this.useStrictDefault;
    }

    public setUseStrictDefault(value: boolean): void {
    ...
    public nextToken(): Token {
        ...
        let { useStrictCurrent } = this;
        const { scopeStrictModes, lastToken } = this;
     ...
     */
    protected RegexPossible(): boolean {
